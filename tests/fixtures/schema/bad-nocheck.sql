...
CREATE TABLE seat_holds (id INTEGER PRIMARY KEY, event_id INTEGER NOT NULL, seat_no TEXT NOT NULL, member_id INTEGER NOT NULL, status TEXT NOT NULL, expires_at INTEGER NOT NULL, created_at INTEGER NOT NULL) STRICT;
