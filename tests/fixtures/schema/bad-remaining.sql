...
CREATE TABLE ticket_types (id INTEGER PRIMARY KEY, event_id INTEGER NOT NULL, name TEXT NOT NULL, price_cents INTEGER NOT NULL, remaining INTEGER NOT NULL , early_bird_until INTEGER) STRICT;
